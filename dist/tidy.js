...
class ft extends NC {
  constructor(g = MA.Tidy, i, t) {
    ...
    if (g === MA.Basic)
      this.tidy = YA.with_basic_layout(i, t);
    else if (g === MA.Tidy)
      this.tidy = YA.with_tidy_layout(i, t);
    else if (g === MA.LayeredTidy)
      this.tidy = YA.with_layered_tidy(i, t);
    else
  ...
  static async create(g = MA.Tidy, i = 40, t = 10) {
    return await ne(), new ft(g, i, t);
  }
  changeLayoutType(g) {
